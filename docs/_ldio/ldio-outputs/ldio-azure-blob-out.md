...
| json-context-uri     | URI which holds the Json Context                                                              | No       | ""      | https://gipod.api.vlaanderen.be/api/v1/context/gipod.jsonld                                 | URI describing [context](https://www.w3.org/TR/json-ld11/#the-context)                                                  |
