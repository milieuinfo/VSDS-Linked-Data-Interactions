...
public class SparqlProcessorProperties {
  ...
  public static final PropertyDescriptor DATA_SOURCE_FORMAT =
      new PropertyDescriptor.Builder()
          ...
          .build();
  public static final PropertyDescriptor SPARQL_SELECT_QUERY =
      new PropertyDescriptor.Builder()
          ...
          .build();
  public static final PropertyDescriptor OUTPUT_NULL_VALUES =
      new PropertyDescriptor.Builder()
          .name("OUTPUT_NULL_VALUES")
          .displayName("Output null values")
          .description(
              "Output named variables in the select query that are not present in a query solution as null values in the resulting json.")
          .required(true)
          .defaultValue(Boolean.TRUE.toString())
          .addValidator(StandardValidators.BOOLEAN_VALIDATOR)
          .build();
  public static final PropertyDescriptor INCLUDE_ORIGINAL =
      new PropertyDescriptor.Builder()
          ...
          .addValidator(StandardValidators.BOOLEAN_VALIDATOR)
          .build();
  public static final PropertyDescriptor SPARQL_CONSTRUCT_QUERY =
      new PropertyDescriptor.Builder()
  ...
  public static final PropertyDescriptor RECORD_WRITER =
      new PropertyDescriptor.Builder()
          ...
          .required(true)
          .build();
  public static final PropertyDescriptor RDF_PAYLOAD_FIELD =
      new PropertyDescriptor.Builder()
  ...
  public static final PropertyDescriptor RETURN_LEXICAL_FORM =
      new PropertyDescriptor.Builder()
          .name("RETURN_LEXICAL_FORM")
          .displayName("Return lexical form")
          .required(true)
          .defaultValue("false")
          .addValidator(StandardValidators.NON_EMPTY_EL_VALIDATOR)
          .allowableValues("true", "false")
          .description("Whether to return lexical form when records are read or not.")
          .build();
  ...
  public static Lang getDataSourceFormat(final ProcessContext context, FlowFile flowFile) {
    return RDFLanguages.nameToLang(
        context.getProperty(DATA_SOURCE_FORMAT).evaluateAttributeExpressions(flowFile).getValue());
  }
}
